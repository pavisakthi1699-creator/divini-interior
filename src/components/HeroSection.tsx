...
const slides = [
  {
    bg: "https://images.unsplash.com/photo-1580480055273-228ff5388ef8?auto=format&fit=crop&w=1800&q=85",
    tag: "Premium Ergonomic Chairs",
    title: "Affordable Furniture\nThat Makes a Difference",
    sub: "World-class ergonomic chairs at unbeatable prices",
    cta: "Shop Now",
    ctaLink: "/shop",
    accent: "#C9A96E",
  },
  {
    bg: "https://images.unsplash.com/photo-1505409628601-edc9af17fda6?auto=format&fit=crop&w=1800&q=85",
    tag: "Herman Miller · Steelcase · Haworth",
    title: "Premium Brands\nAt Honest Prices",
    sub: "Refurbished & new ergonomic chairs for professionals",
    cta: "View Collection",
    ctaLink: "/shop",
    accent: "#C9A96E",
  },
  {
    bg: "https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?auto=format&fit=crop&w=1800&q=85",
    tag: "Pan-India Delivery",
    title: "Every Purchase\nHelps the Planet",
    sub: "Sustainable choices for a greener tomorrow",
    cta: "Explore",
    ctaLink: "/shop",
    accent: "#C9A96E",
  },
