...
const ORDER_STATUS_CONFIG: Record<OrderStatus, { label: string; className: string }> = {
  pending:    { label: 'New Enquiry',    className: 'bg-yellow-100 text-yellow-800 border-yellow-200' },
  confirmed:  { label: 'Under Review',  className: 'bg-blue-100 text-blue-800 border-blue-200' },
  processing: { label: 'Quoting', className: 'bg-indigo-100 text-indigo-800 border-indigo-200' },
  shipped:    { label: 'Sent to Client',className: 'bg-purple-100 text-purple-800 border-purple-200' },
  delivered:  { label: 'Completed',  className: 'bg-green-100 text-green-800 border-green-200' },
  cancelled:  { label: 'Closed',  className: 'bg-red-100 text-red-800 border-red-200' },
  refunded:   { label: 'Revised',   className: 'bg-gray-100 text-gray-800 border-gray-200' },
};

const PAYMENT_STATUS_CONFIG: Record<PaymentStatus, { label: string; className: string }> = {
  pending:  { label: 'Pending Quote',  className: 'bg-yellow-100 text-yellow-800 border-yellow-200' },
  paid:     { label: 'Quote Sent',     className: 'bg-green-100 text-green-800 border-green-200' },
  failed:   { label: 'Declined',   className: 'bg-red-100 text-red-800 border-red-200' },
  refunded: { label: 'Revised', className: 'bg-gray-100 text-gray-800 border-gray-200' },
};
